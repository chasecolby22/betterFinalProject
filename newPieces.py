...
class piece(dumbPiece):
    ...
    def cCanMove(self, presentTile, futureTile):
        ...
        if anX == oldX and oldY == aY:
            return False
        anArray = self.canMove(presentTile, futureTile)
        if not anArray:
            return False
        newTile = anArray[0]
